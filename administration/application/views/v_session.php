          ...
          <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <form action="index.php?action=valideConnexion" method="POST">
                        <fieldset>
                    ...
                    <h5 class="card-title text-center">Festivals en suppression</h5>
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                    ...
                                    <?php foreach($lesSessionsSup as $uneSession): ?>
                                 <!--       <tr>
                                            <?php
                
                                                $numJour = date("d",strtotime($uneSession['suppression']));


                                                $nmJour = date("D",strtotime($uneSession['suppression']));
                                                $nomJour = "";
                                                if($nmJour == "Mon"){
                                                    $nomJour = "Lundi";
                                                }
                                                ...
                                                $nmMois = date("M",strtotime($uneSession['suppression']));
                                                $nomMois = "";
                                                ...
                                                $nomAnnee = date("Y",strtotime($uneSession['suppression'])); ?>



                                            <td><?php echo $uneSession['nomSession']; ?></td>
                                            <td><?php echo $nomJour." ".$numJour." ".$nomMois." ".$nomAnnee; ?></td>
                                            <td>
                                                <form class="form-signin" method="POST" action="index.php?action=annulerSupprimerSession">
                                                    <input id="prodId" name="idSession" type="hidden" value="<?php echo $uneSession['idSession'] ?>">
                                                    <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">⤺</button>
