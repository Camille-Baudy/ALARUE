...
//Url l'url de votre site à modifier en fonction du déploiement
    define('URL','http://administration.zaccros.org/');
...
//EXCELPATH où se trouvent mes gestions de excels de page
    define('EXCELPATH', APPATH.'excels'.DIRECTORY_SEPARATOR);
//VIEWSPATH où se trouvent mes vues
    define('VIEWSPATH',APPATH.'views'.DIRECTORY_SEPARATOR);
//CALENDARAPPATH où se trouvent mes vues
    define('CALENDARAPPATH',VIEWSPATH.'calendrier'.DIRECTORY_SEPARATOR);
