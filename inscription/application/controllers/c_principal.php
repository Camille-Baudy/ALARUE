...
switch($action)
{
	...
	case 'validationMission':
	{
		...
		if(isset ($_SESSION['nom']))
		{
			...
			foreach($idSession as $s):
			$uneSession = inscription\getLaSession($s['idSession']);
			endforeach;
			...
			if(isset($_REQUEST['8h'])){
				...
				$end = $_REQUEST['leJour']." 09:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['9h'])){
				$start = $_REQUEST['leJour']." 09:00:00";
				$end = $_REQUEST['leJour']." 10:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['10h'])){
				$start = $_REQUEST['leJour']." 10:00:00";
				$end = $_REQUEST['leJour']." 11:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['11h'])){
				$start = $_REQUEST['leJour']." 11:00:00";
			...
			if(isset($_REQUEST['12h'])){
				...
				$end = $_REQUEST['leJour']." 13:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['13h'])){
				$start = $_REQUEST['leJour']." 13:00:00";
			...
			if(isset($_REQUEST['14h'])){
				...
				$end = $_REQUEST['leJour']." 15:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['15h'])){
				$start = $_REQUEST['leJour']." 15:00:00";
				$end = $_REQUEST['leJour']." 16:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['16h'])){
				$start = $_REQUEST['leJour']." 16:00:00";
				$end = $_REQUEST['leJour']." 17:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['17h'])){
				$start = $_REQUEST['leJour']." 17:00:00";
			...
			if(isset($_REQUEST['18h'])){
				...
				$end = $_REQUEST['leJour']." 19:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['19h'])){
				$start = $_REQUEST['leJour']." 19:00:00";
				$end = $_REQUEST['leJour']." 20:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['20h'])){
				$start = $_REQUEST['leJour']." 20:00:00";
				$end = $_REQUEST['leJour']." 21:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['21h'])){
				$start = $_REQUEST['leJour']." 21:00:00";
			...
			if(isset($_REQUEST['22h'])){
				...
				$end = $_REQUEST['leJour']." 23:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);

			}

			if(isset($_REQUEST['23h'])){
				$start = $_REQUEST['leJour']." 23:00:00";
			...
			if(isset($_REQUEST['00h'])){
				$start = $_REQUEST['leJour']." 00:00:00";
				$leJour = $_REQUEST['leJour'];
				$leJour = date('Y-m-d', strtotime($leJour. ' + 1 days'));
				$end = $leJour." 01:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);
			...
			if(isset($_REQUEST['01h'])){
				$start = $_REQUEST['leJour']." 01:00:00";
				$leJour = $_REQUEST['leJour'];
				$leJour = date('Y-m-d', strtotime($leJour. ' + 1 days'));
				$end = $leJour." 02:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);
			...
			if(isset($_REQUEST['02h'])){
				$start = $_REQUEST['leJour']." 02:00:00";
				$leJour = $_REQUEST['leJour'];
				$leJour = date('Y-m-d', strtotime($leJour. ' + 1 days'));
				$end = $leJour." 03:00:00";
				inscription\ajouterHoraireLibreBenevole($start, $end, $idBenevole, $idSession);
