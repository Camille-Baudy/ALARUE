         ...
         <div class="container">
             ...
             <form>
               <fieldset>
                ...
                <div class="form-group">
                   <label for="rue">Entrez votre nom de rue :</label><label class="text-danger">&nbsp*</label>
                   <input type="text" class="form-control" name="rue"  required placeholder="Entrez votre nom de rue">
                 </div>
                ...
                <div class="form-row">
					...
					<div class="form-group col-md-5">
						<label for="ville">Entrez le nom de votre ville :</label><label class="text-danger">&nbsp*</label><br/>
